                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12}>
                    <Typography variant='subtitle1' sx={{ fontWeight: 400, color: theme.palette.common.white }}>
                      Since 2013, More than 5K+ Developers trust the Phoenixcoded Digital Product. Able Pro Material
                      React is Manage under
                ...
                <Grid item xs={6} sm={3}>
                  <Stack spacing={{ xs: 3, md: 5 }}>
                    ...
                    <Stack spacing={{ xs: 1.5, md: 2.5 }}>
                      ...
                      <FooterLink href='https://codedthemes.gitbook.io/able-pro-react/' target='_blank'
                                  underline='none'>
                        Documentation
                      </FooterLink>
                      <FooterLink href='https://codedthemes.gitbook.io/able-pro-react/changelog' target='_blank'
                                  underline='none'>
                        Change Log
                      </FooterLink>
