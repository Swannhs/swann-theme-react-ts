        ...
        <FormControlLabel
          ...
          label={
            <MainCard
              ...
              sx={{
                borderWidth: 2,
                p: 1, ...(theme.palette.mode === 'light' && { borderColor: theme.palette.primary.main })
              }}
            >
        ...
        <FormControlLabel
          ...
          label={
            <MainCard
              ...
              sx={{
                borderWidth: 2,
                p: 1, ...(theme.palette.mode === 'dark' && { borderColor: theme.palette.primary.main })
              }}
            >
              <Stack direction='row' alignItems='center' justifyContent='center' sx={{ height: 44 }}>
                <Moon variant='Bold' />
        ...
        <FormControlLabel
          ...
          label={
            <MainCard content={false} sx={{
              borderWidth: 2,
              p: 1, ...(mode === 'auto' && { borderColor: theme.palette.primary.main })
            }}>
              <Stack direction='row' alignItems='center' justifyContent='center' sx={{ height: 44 }}>
