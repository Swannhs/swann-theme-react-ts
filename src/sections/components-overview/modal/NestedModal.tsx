    ...
    <>
      ...
      <Modal open={open} onClose={handleClose} aria-labelledby='child-modal-title'
        ...
        <MainCard title='Child Modal' modal darkTitle content={false}>
          <CardContent>
            <Typography id='modal-modal-description'>Lorem ipsum, dolor sit amet consectetur adipisicing
              elit.</Typography>
            <Typography id='modal-modal-description'>Lorem ipsum, dolor sit amet consectetur adipisicing
              elit.</Typography>
            <Typography id='modal-modal-description'>Lorem ipsum, dolor sit amet consectetur adipisicing
        ...
        <MainCard title='Parent Modal' modal darkTitle content={false}>
          <CardContent>
            <Typography id='modal-modal-description'>
              Duis mollis, est non commodo luctus, nisi erat porttitor ligula.Duis mollis, est non commodo luctus, nisi
              erat porttitor
              ligula.
            </Typography>
          </CardContent>
