                  ...
                  label={
                    <Grid container>
                      <Stack direction='row' alignItems='center' spacing={1}>
                        ...
                        <Typography
                          color={index > cart.checkout.step ? 'textSecondary' : 'inherit'}>{tab.label}</Typography>
                      </Stack>
                    </Grid>
                  }
                />
      ...
      <Grid container>
        <Grid item xs={12}>
          <TabPanel value={value} index={0}>
            {isCart && <Cart checkout={cart.checkout} onNext={onNext} removeProduct={removeCartProduct}
