            ...
            <Grid container alignItems='center' spacing={3}>
              <Grid item xs={12}>
                <Stack spacing={1}>
                  ...
                  <NumberFormat format='+1 (###) ###-####' mask='_' fullWidth customInput={TextField}
              ...
              <Grid item xs={12}>
                <Stack spacing={1}>
                  ...
                  <NumberFormat format='+91 #### ###-####' mask='_' fullWidth customInput={TextField}
              ...
              <Grid item xs={12}>
                <Stack spacing={1}>
                  ...
                  <NumberFormat format='(##) ####-#####' mask='_' fullWidth customInput={TextField}
