              ...
              <MainCard title='Label Placement' codeString={labelCheckboxCodeString}>
                <FormControl component='fieldset'>
                  <FormGroup aria-label='position' row>
                    ...
                    />
                    <FormControlLabel value='bottom' control={<Checkbox />} label='Bottom' labelPlacement='bottom' />
                    <FormControlLabel value='end' control={<Checkbox defaultChecked />} label='End' labelPlacement='end'
                                      sx={{ ml: 1 }} />
                  </FormGroup>
                </FormControl>
              </MainCard>
              <MainCard title='Indeterminate' codeString={indeterminateCheckboxCodeString}>
                <>
                  <FormControlLabel
                    label='Parent'
                    control={
                      <Checkbox checked={checked[0] && checked[1]} indeterminate={checked[0] !== checked[1]}
