          ...
          <Grid item xs={12} lg={6}>
            <MainCard title='Outlined' codeString={outlinedChipCodeString}>
              <Grid container spacing={2}>
                ...
                <Grid item>
                  <Chip variant='outlined' avatar={<Avatar alt='Natacha' src={avatarDark} />} label='Avatar'
                        color='primary' />
                </Grid>
              </Grid>
            </MainCard>
          ...
          <Grid item xs={12} lg={6}>
            <MainCard title='Lighter' codeString={lighterChipCodeString}>
              <Grid container spacing={2}>
                ...
                <Grid item>
                  <Chip variant='light' avatar={<Avatar alt='Natacha' src={avatarDark} />} label='Avatar'
                        color='primary' />
                </Grid>
              </Grid>
            </MainCard>
          ...
          <Grid item xs={12} lg={6}>
            <MainCard title='Combined' codeString={combineChipCodeString}>
              <Grid container spacing={2}>
                ...
                <Grid item>
                  <Chip variant='combined' avatar={<Avatar alt='Natacha' src={avatarDark} />} label='Avatar'
                        color='primary' />
                </Grid>
              </Grid>
            </MainCard>
          ...
          <Grid item xs={12} lg={6}>
            <MainCard title='Deletable Icon' codeString={deleteChipCodeString}>
              <Grid container spacing={2}>
                ...
                <Grid item>
                  <Chip label='Custom Icon' onDelete={() => {
                  }} color='error' deleteIcon={<MinusSquare />} />
                </Grid>
                <Grid item>
                  <Chip variant='outlined' label='Custom Icon' onDelete={() => {
                  }} color='error' deleteIcon={<Trash variant='Bold' />} />
                </Grid>
              </Grid>
            </MainCard>
          </Grid>
          <Grid item xs={12} lg={6}>
            <MainCard title='Avatar & Icon' codeString={avatarChipCodeString}>
              <Grid container spacing={2}>
                ...
                <Grid item>
                  <Chip variant='combined' color='primary' avatar={<Avatar alt='Natacha' src={avatarDark} />}
                        label='Avatar' />
                </Grid>
                <Grid item>
                  <Chip color='warning' variant='outlined' icon={<EmojiHappy variant='Bold' />} label='Smile' />
