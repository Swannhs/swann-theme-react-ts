            ...
            <MainCard title='Primary Color'>
              <Stack>
                ...
                <ColorBox
                  ...
                  dark
                />
                <ColorBox bgcolor='primary.400' data={{ label: 'Blue-5', color: `${theme.palette.primary[400]}` }}
                          title='primary[400]' />
                <ColorBox
                  ...
                  main
                />
                <ColorBox bgcolor='primary.dark' data={{ label: 'Blue-7', color: `${theme.palette.primary.dark}` }}
                          title='primary.dark' />
                <ColorBox bgcolor='primary.700' data={{ label: 'Blue-8', color: `${theme.palette.primary[700]}` }}
                          title='primary[700]' />
                <ColorBox
                ...
                />
                <ColorBox bgcolor='primary.900' data={{ label: 'Blue-10', color: `${theme.palette.primary[900]}` }}
                          title='primary.900' />
              </Stack>
            </MainCard>
          </Grid>
            ...
            <MainCard title='Success Color'>
              <Stack>
                ...
                <ColorBox
                  ...
                  main
                />
                <ColorBox bgcolor='success.dark' data={{ label: 'Green-8', color: `${theme.palette.success.dark}` }}
                          title='success.dark' />
                <ColorBox
            ...
            <MainCard title='Error Color'>
              <Stack>
                <ColorBox
                  ...
                  dark
                />
                <ColorBox bgcolor='error.light' data={{ label: 'Red-4', color: `${theme.palette.error.light}` }}
                          title='error.light' dark />
                <ColorBox bgcolor='error.main' data={{ label: 'Red-6', color: `${theme.palette.error.main}` }}
                          title='error.main' main />
                <ColorBox bgcolor='error.dark' data={{ label: 'Red-8', color: `${theme.palette.error.dark}` }}
                          title='error.dark' />
                <ColorBox bgcolor='error.darker' data={{ label: 'Red-10', color: `${theme.palette.error.darker}` }}
                          title='error.darker' />
              </Stack>
            </MainCard>
          </Grid>
            ...
            <MainCard title='Warning Color'>
              <Stack>
                ...
                <ColorBox
                  ...
                  main
                />
                <ColorBox bgcolor='warning.dark' data={{ label: 'Gold-8', color: `${theme.palette.warning.dark}` }}
                          title='warning.dark' />
                <ColorBox
