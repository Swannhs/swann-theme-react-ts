          ...
          <Grid item xs={12} lg={6}>
            <Stack spacing={3}>
              ...
              <MainCard title='Linear With Label / Icon' codeString={llProgressCodeString}>
                <Stack spacing={1}>
                  <LinearWithIcon value={100} color='success'
                                  icon={<TickCircle variant='Bold' color={theme.palette.success.main} />} />
                  <LinearWithLabel variant='determinate' value={progress} />
                  <LinearWithIcon value={5} color='error'
                                  icon={<CloseCircle variant='Bold' color={theme.palette.error.main} />} />
                </Stack>
              </MainCard>
