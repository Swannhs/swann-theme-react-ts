  ...
  return (
    <Grid container spacing={3}>
      <Grid item xs={12} md={4} lg={3} sm={6}>
        <ReportCard primary='$30200' secondary='All Earnings' color={theme.palette.secondary.main}
                    iconPrimary={Chart} />
      </Grid>
      <Grid item xs={12} md={4} lg={3} sm={6}>
      ...
      <Grid item xs={12} md={4} lg={3} sm={6}>
        <ReportCard primary='290+' secondary='Page Views' color={theme.palette.success.main}
                    iconPrimary={DocumentText} />
      </Grid>
      <Grid item xs={12} md={4} lg={3} sm={6}>
        <ReportCard primary='500' secondary='Downloads' color={theme.palette.primary.main}
      ...
      <Grid item xs={12} md={4} lg={3} sm={6}>
        <HoverSocialCard primary='Dribbble Posts' secondary='780 +' iconPrimary={Dribbble}
      ...
      <Grid item xs={12} md={4} lg={3} sm={6}>
        <HoverSocialCard primary='Youtube Videos' secondary='650 +' iconPrimary={Youtube}
